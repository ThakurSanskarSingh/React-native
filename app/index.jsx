    ...
    <ScrollView contentContainerStyle = {{height : '100%'}}>
      <View className = "w-full justify-center items-center h-full px-4 ">
        ...
        <View className = 'relative mt-5'>
          ...
          <Image source={images.path} className = 'w-[136px] h-[10px] absolute -bottom-2 -right-8 ' 
          resizeMode='contain'/>

        </View>
        <Text className = 'text-gray-100 mt-7 text-sm font-pregular text-center'>
          Where creativity meets innovation: emabark on a journey of limitless exploration Aora 
        </Text>
        <CustomBottom
